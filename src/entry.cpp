...
namespace dci::module::ppn::service::aup
{
    namespace
    {
        struct Manifest
            : public dci::host::module::Manifest
        {
            Manifest()
            {
                ...
                pushServiceId<idl::ppn::service::Aup>();
            }
        } manifest_;
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Aup>(ilid)) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::service::aup::entry_;
}
